...
# sys.path.append(args[''])  # To find local version of the library
...
class LemnaDataset(utils.Dataset):
    ...
    def load_lemna(self, dataset_dir, subset):
        ...
        for a in annotations:
            # Get the x, y coordinaets of points of the points that make up
            ...
            # load_mask() needs the image size to convert points to masks.
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        # Convert points to a bitmap mask of shape
...
if __name__ == '__main__':
    ...
    if args['command'] == "train":
        ...
        class InferenceConfig(LemnaConfig):
    ...
    if args['model_pretrained'].lower() == "coco":
    ...
    if args['command'] == "train":
        ...
        pass
        detect_and_color_splash(model, image_path=args['splash_img'])
    else:
